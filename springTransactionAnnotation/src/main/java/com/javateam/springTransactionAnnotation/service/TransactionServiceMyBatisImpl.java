...
import com.javateam.springTransactionAnnotation.dao.TransactionDAOMyBatisImpl;
...
public class TransactionServiceMyBatisImpl implements TransactionServiceMyBatis {
	...
	public TransactionServiceMyBatisImpl(@Qualifier("txDAOMyBatis") TransactionDAOMyBatis dao) {
		this.dao = dao;
	}
